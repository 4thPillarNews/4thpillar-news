        ...
        try:
            ...
            for e in d.entries[:5]:
                ...
                new_list.append({
                    ...
                    "para3":"स्थानीय नागरिकों का कहना है कि यदि इस पर समय रहते उचित कदम उठाए गए तो आम जनता को इसका सीधा लाभ मिलेगा।",
...
if not new_list and not old_news:
    new_list.append({
        ...
        "para1":"गाजियाबाद में विकास कार्यों को लेकर चर्चा तेज हो गई है।",
        "para2":"विभाग ने पूरी तैयारी कर ली है।",
        "para3":"स्थानीय नागरिकों को सीधा लाभ मिलेगा।",
        "para4":"रिपोर्टर गौरव शर्मा ने बताया कि प्रशासन की नजर बनी हुई है।",
        "para5":"प्रशासन ने कहा लापरवाही बर्दाश्त नहीं होगी।",
        "para6":"बड़ा खुलासा सामने आने की संभावना है।",
        "para7":"राजनीतिक क्षेत्रों में हलचल तेज हो गई है।",
